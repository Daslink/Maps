...
/**
 * Test for transaction CDRGT00001COTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/CDRGT00001COTest.xml" })
public class CDRGT00001COTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(CDRGT00001COTransactionTest.class);
	
	@Autowired
	private CDRGT00001COTransaction transaction;
